  ...
  productSwitcher = [
    {
      ...
      image: './assets/01.png',
      callback: $event => {
        this.productSwitcherCallback($event, 'Fiori Home');
      },
    },
    {
      ...
      image: './assets/02.png',
      callback: $event => {
        this.productSwitcherCallback($event, 'S/4 HANA Cloud');
      },
    },
    {
      ...
      image: './assets/03.png',
      callback: $event => {
        this.productSwitcherCallback($event, 'Analytics Cloud');
      },
    },
    {
      title: 'Ariba',
      image: './assets/04.png',
      callback: $event => {
        this.productSwitcherCallback($event, 'Ariba');
      },
    },
    {
      ...
      image: './assets/05.png',
      callback: $event => {
        this.productSwitcherCallback($event, 'SuccessFactors');
      },
    },
    {
      ...
      image: './assets/06.png',
      callback: $event => {
        this.productSwitcherCallback($event, 'Commerce Cloud');
      },
    },
    {
      title: 'Gigya',
      image: './assets/07.png',
      callback: $event => {
        this.productSwitcherCallback($event, 'Gigya');
      },
    },
    {
      ...
      image: './assets/08.png',
      callback: $event => {
        this.productSwitcherCallback($event, 'Callidus Cloud');
      },
    },
    {
      title: 'Fieldglass',
      image: './assets/09.png',
      callback: $event => {
        this.productSwitcherCallback($event, 'Fieldglass');
      },
    },
    {
      title: 'Concur',
      image: './assets/10.png',
      callback: $event => {
        this.productSwitcherCallback($event, 'Concur');
      },
    },
    {
      ...
      image: './assets/11.png',
      callback: $event => {
        this.productSwitcherCallback($event, 'Cloud for Customer');
      },
    },
    {
      title: 'Cloud Portal',
      image: './assets/12.png',
      callback: $event => {
        this.productSwitcherCallback($event, 'Cloud Portal');
      },
    },
  ];
